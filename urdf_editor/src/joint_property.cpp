...
namespace urdf_editor
{
  ...
  // Joint Property
  JointProperty::JointProperty(boost::shared_ptr<urdf::Joint> joint, QStringList &link_names, QStringList &joint_names, URDFTransformer *tf): joint_(joint), manager_(new QtVariantPropertyManager()), factory_(new QtVariantEditorFactory()), link_names_(link_names), joint_names_(joint_names), tf_(tf)
  {
    loading_ = true;
